...
<br />
          ...
          <div class="col-lg-4">
                   ...
                   <br />
                   <br />
            <asp:Button ID="btnCadastrar" runat="server"  OnClick="btnCadastrar_Click" Text="Cadastrar" Width="300px" BackColor="#0066FF" BorderColor="#0066FF" ForeColor="White" Height="50px" CausesValidation="False" />
            ...
            <asp:Button ID="btnVoltar" runat="server"  OnClick="btnVoltar_Click" Text="Retornar ao Menu" Width="300px" BackColor="#0066FF" BorderColor="#0066FF" ForeColor="White" Height="50px" CausesValidation="False" />
                   ...
                   <asp:SqlDataSource ID="sqlCadastrarProcurador" runat="server" ConnectionString="<%$ ConnectionStrings:quickjobsConnectionString %>" InsertCommand="INSERT INTO procurador(foto, sexo, data_nasc, data_cadastro, cpf, tel, email, senha, cep, num_residencial, complemento, pontuacao, nome, status) VALUES (@FOTO, @SEXO, @DATA, DEFAULT, @CPF, @CEL, @EMAIL, @SENHA, @CEP, @NUM, @COMPL, @PONT, @NOME, 0)" ProviderName="<%$ ConnectionStrings:quickjobsConnectionString.ProviderName %>" SelectCommand="SELECT * FROM procurador" OnSelecting="sqlCadastrarProcurador_Selecting">
                       <InsertParameters>
                           ...
                           <asp:Parameter Name="COMPL" DefaultValue="" />
                           <asp:Parameter DefaultValue="0" Name="PONT" />
                       </InsertParameters>
                   </asp:SqlDataSource>
                   <br />
                       </div>
