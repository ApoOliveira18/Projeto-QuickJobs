<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuProcurador.aspx.cs" Inherits="MenuProcurador" %>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class ="col-lg-6"> 
              ...
              <asp:Button ID="btnServicos" runat="server" Text="Solicitar Pedidos"  OnClick="btnServicos_Click" Width="300px" BackColor="#0066FF" BorderColor="#0066FF" ForeColor="White" Height="50px" />  
              <br />
              <br />
            
              <asp:Button ID="btnGerenciarServ" runat="server" Text="Gerenciar Pedidos"  OnClick="btnGerenciarServ_Click" Width="300px" BackColor="#0066FF" BorderColor="#0066FF" ForeColor="White" Height="50px" />  
              <br />
              <br />
            
              <asp:Button ID="btnContrato" runat="server" Text="Ver Contratos"  OnClick="btnGerenciar_Click" Width="300px" BackColor="#0066FF" BorderColor="#0066FF" ForeColor="White" Height="50px" />  
            <br />
            <br />
