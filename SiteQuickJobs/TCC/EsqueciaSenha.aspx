 ...
 <!--==========================
  ...
  <section id="intro" class="clearfix">
    <div class="container">
        ...
        <div>
            Nome:
            <asp:TextBox ID="txtNome" runat="server" Width="273px"></asp:TextBox>
            &nbsp;<br />
            <br />
            Email:
            <asp:TextBox ID="txtEmail" runat="server" ToolTip="Digite seu email" OnTextChanged="txtEmail_TextChanged" Width="276px"></asp:TextBox>           
            &nbsp;<asp:Label ID="lblErroEmail" runat="server"></asp:Label>
            <br />
            <br />
            Selecione seu tipo de conta: <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
