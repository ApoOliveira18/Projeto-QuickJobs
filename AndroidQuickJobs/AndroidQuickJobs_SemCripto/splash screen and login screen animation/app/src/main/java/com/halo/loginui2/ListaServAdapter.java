...
public class ListaServAdapter extends BaseAdapter {
    ...
    // Inicia o Layout e o List para receber a lista de servicos
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Programação para colocar os dados recebidos em seus respectivos labels
    ...
    private class ItemSuporte {
        ...
        // labels que irão receber informações do banco de dados
